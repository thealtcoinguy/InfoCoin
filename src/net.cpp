...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Infocoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"infocoin.org", "dnsseed.infocoin.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"infocoin.org", "testnet-seed.infocoin.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Infocoin is probably already running."), addrBind.ToString().c_str());
        else
